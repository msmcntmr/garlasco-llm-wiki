...
export interface ExplorerOptions {
  ...
  // Overrides folderDefaultState: folders at this depth or shallower (root's
  // direct children are depth 1) default open, deeper ones default collapsed.
...
export default ((userOpts?: Partial<ExplorerOptions>) => {
  ...
  const defaultOpenDepth =
    opts.folderDefaultOpenDepth ?? (opts.folderDefaultState === "open" ? Infinity : 0);
