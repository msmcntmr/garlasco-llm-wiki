...
var Explorer_default = ((userOpts) => {
  ...
  const defaultOpenDepth = opts.folderDefaultOpenDepth ?? (opts.folderDefaultState === "open" ? Infinity : 0);
  ...
  const ExplorerComponent = (props) => {
    ...
    return /* @__PURE__ */ u2(
      "div",
      {
        ...
        "data-collapsed-depth": defaultOpenDepth === Infinity ? "Infinity" : defaultOpenDepth,
